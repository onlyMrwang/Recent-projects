  ...
  <div class="cardLoss">
    ...
    <div class="content">
      <div class="infoBox" v-if="accInfo">
        ...
        <!-- 卡列表 -->
        <div class="table">
            <ShareItem v-if="accInfo.accType === 0" :searchInfo="searchConf" :accId="accInfo.accId" ref="shareItem"/>
            <QuotaItem v-if="accInfo.accType === 2" :searchInfo="searchConf" :accId="accInfo.accId" ref="quotaItem"/>
            <PrivateItem v-if="accInfo.accType === 3" :searchInfo="searchConf" :accId="accInfo.accId" ref="privateItem"/>
        </div>
       ...
       if(!rsp.data || JSON.stringify(rsp.data) === '{}') {
          ...
          this.$nextTick(() => {
           if(rsp.data.accType === 0) {
            ...
            this.$refs.privateItem.fetchCards()
           } 
          })
