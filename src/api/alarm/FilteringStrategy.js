...
export function doStartKnowledgeConfig(query) {
    return request({
        url: '/app/alarm/pole-filter-config/doStartPoleFilterConfig',
        method: 'put',
        data: query
    })
}
...
export function stopWledgeConfig(query) {
    return request({
        url: '/app/alarm/pole-filter-config/doStopPoleFilterConfig',
        method: 'put',
        data: query
    })
}
...
export function clertList(query) {
    return request({
        url: '/app/alarm/pole-filter-config/deletePoleFilterConfig',
        method: 'post',
        data: query
    })
}
