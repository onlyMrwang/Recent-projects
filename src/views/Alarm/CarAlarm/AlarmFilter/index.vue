    ...
    <div class="tableBox">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="ruleName" label="过滤策略名称" align="center">
          </el-table-column>
          <el-table-column prop="ruleName" label="状态" align="center">
            ...
            <template slot-scope="scope">
              <div>
                ...
                <el-link
                  ...
                  style="margin-right: 10px;"
                >
                  {{ scope.row.validTag == 1 ? '停用' : '启用' }}</el-link
                >
                <el-link
                  :underline="false"
    ...
    <div v-if="showSetting">
      ...
      >
        <AddList
          ...
          :ruleForms="ruleForm"
          :subTypes="subType"
          @clearDialog="closeSetting(arguments)"
          :treeType="2"
        />
      </el-dialog>
    </div>
