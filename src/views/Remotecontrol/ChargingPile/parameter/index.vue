...
import {
  ...
  getEquipment,
  list
} from '@/api/remotecontrol/chargingpile/params.js'
// import Search from "@/views/Remotecontrol/components/search.vue"
export default {
  name: 'Workparams',
  //   components:{Search},
  data() {
  ...
  methods: {
    ...
    down() {
      ...
      obj.checkInInterval = this.dialogform.time
