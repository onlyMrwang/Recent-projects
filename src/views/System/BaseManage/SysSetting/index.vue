<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="参数名称" prop="nameCN">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="归属模块" prop="module">
          <el-input v-model="form.module" placeholder="请输入归属模块" />
        </el-form-item>
        <el-form-item label="参数键名" prop="name">
          <el-input v-model="form.name" placeholder="请输入参数键名" />
        </el-form-item>
        <el-form-item label="参数名称" prop="nameCN">
          <el-input v-model="form.nameCN" placeholder="请输入参数名称" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        name: [{ required: true, message: "参数键名不能为空", trigger: "blur" }]
      }
    };
  },
  created() {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除参数名为"' + nameCNs + '"的数据项?', "警告", {
