  ...
  <div class="addFault">
    ...
    >
      ...
      <div class="formContent">
        ...
        <div class="formList">
          <el-form-item label="车牌号 :" prop="deviceNames">
            <el-input
      ...
      <div class="formContent">
        <div class="formList">
          <el-form-item label="厂商 :" prop="deviceVenders">
            <el-select
        ...
        <div class="formList">
          <el-form-item label="型号 :" prop="deviceVersons">
            <el-input
              placeholder="请输入型号"
              v-model="ruleForm.deviceVersons"
            ></el-input>
            <!-- <el-select
              v-model="ruleForm.deviceVenders"
              clearable
