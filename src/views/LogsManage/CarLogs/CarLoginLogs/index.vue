        ...
        <el-row :gutter="5">
          ...
          <el-col :span="6">
            <el-form-item label="车牌号">
              <el-select
                v-model="searchInfo.licensePlate"
                clearable
                filterable
                placeholder="请选择车牌号"
              >
...
import {
  getList,
  getCarNumberByOrgName
} from '@/api/alarm/caralarm/carLoginlogs'
...
export default {
  ...
  watch: {
    ...
    'searchInfo.organization'(newVal, oldVal) {
      if (newVal === null || newVal === undefined) {
        return false
      } else {
        getCarNumberByOrgName({
          name: this.searchInfo.organization
        }).then((res) => {
