      ...
      :header-cell-style="tableHeaderStyle">
            ...
            <el-table-column prop="x" label="操作" align="center">
              <template slot-scope="scope">
               ...
               >
                <el-link :underline="false" type="primary" slot="reference">{{scope.row.status == '1' ? '挂失' : '解挂'}}</el-link>
              </el-popconfirm>
              </template>
            </el-table-column>
          </el-table>
...
<script>
import { getAccountPrivate, updateCardState } from '@/api/financial/account'
