    ...
    <div class="chrOrderSea">
        ...
        <div class="tableBox">
            <div class="top">
                ...
                <div class="options">
                    <el-button type="primary" icon="el-icon-plus" @click="upDateEdit(1)" >新增</el-button>
                </div>
            </div>
            <div class="table">
                <el-table
       ...
       <div v-if="showSetting">
        ...
        >
            <AddList :levelList="levelList" :faultInfo="ruleForm" :subType="subType" @cleraDialog="closeSetting(arguments)" :treeType='2' />
        </el-dialog>
     </div>
    </div>
</template>
...
<script>
    import { getList, doStartKnowledgeConfig, stopWledgeConfig, clertList } from "@/api/alarm/BeforeFiltering.js";
    ...
    export default {
        ...
        methods: {
            ...
            //列表停用启用方法
            handleEdit(val){
            this.$confirm(val.validTag==1 ? '是否确定停用该告警通知策略' : '是否确定启用该告警通知策略', '提示', {
                confirmButtonText: '确定',
                type: 'warning',
                center: true
            }).then(() => { 
