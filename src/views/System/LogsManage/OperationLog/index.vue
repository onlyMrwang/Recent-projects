    ...
    <div class="card">
      ...
      >
        <el-row :gutter="20">
          ...
          <el-col :span="7">
            <el-form-item prop="userName" label="操作人员">
              <el-input
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="操作模块："
              >{{ form.module }} / {{ typeFormat(form) }}</el-form-item
            >
            <el-form-item label="登录信息："
              >{{ form.userName }} / {{ form.callerHost }} /
          ...
          <el-col :span="24">
            <el-form-item label="花费时间："
              >{{ form.cost }} (毫秒)</el-form-item
            >
          </el-col>
          <el-col :span="24">
            <el-form-item label="请求参数：">{{ form.extention }}</el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="错误信息：">{{ form.msg }}</el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { list, delLog, cleanLog, exportLog } from "@/api/monitor/operlog";
