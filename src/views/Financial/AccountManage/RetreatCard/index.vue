  ...
  <div class="cardLoss">
    ...
    <div class="content">
      <div class="infoBox" v-if="accInfo">
        ...
        <div class="accInfo">
          ...
          <!-- <div class="item" v-if="accInfo.accUse === 0">
            ...
            <span class="value" v-if="accInfo.accType === 0"
              >总金额
              <span style="color: red;margin-left: 10px">{{Number(accInfo.totalAmount) > 0 ? (accInfo.totalAmount).toFixed(6) : 0}}</span></span
            >
          </div> -->
        ...
        <!-- 卡列表 -->
        <div class="table">
            <ShareItem v-if="accInfo.accType === 0" :searchInfo="searchConf" :accId="accInfo.accId" ref="share"/>
            <QuotaItem v-if="accInfo.accType === 2" :searchInfo="searchConf" :accId="accInfo.accId" ref="quota"/>
            <PrivateItem v-if="accInfo.accType === 3" :searchInfo="searchConf" :accId="accInfo.accId" ref="private"/>
        </div>
