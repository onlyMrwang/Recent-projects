<template>
  <div class="shareBox">
    ...
    >
      ...
      <span slot="footer">
        <el-button type="primary" :loading="showAddCarLoading" @click="submitAddCar">确 定</el-button>
    ...
    >
      ...
      <span slot="footer">
        <el-button type="primary" :loading="showAddPersonLoading" @click="submitAddPerson">确 定</el-button>
...
.settingAddBox .addItem .el-input__inner {
  width: 440px !important;
}
.addItem .cardDuan .el-input__inner {
