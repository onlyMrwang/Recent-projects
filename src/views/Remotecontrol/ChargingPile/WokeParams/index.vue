  ...
  <div class="app-container" style="">
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="14">
            <el-form-item label="中心服务器地址">
              <el-input
                v-model="dialogform.centralServerAddress"
                placeholder="请输入中心服务器地址"
                clearable
                size="small"
              />
            </el-form-item>
          ...
          <el-col :span="14">
            <el-form-item label="中心服务器端口">
              <el-input
                v-model="dialogform.centralServerPort"
                placeholder="请输入中心服务器端口"
                clearable
                size="small"
              />
            </el-form-item>
...
// import {toIssue,list} from "@/api/remotecontrol/chargingpile/workparams.js"
import {
  toIssue,
  getChargGroupCode,
  getEquipment,
  list
} from '@/api/remotecontrol/chargingpile/workparams.js'
export default {
  name: 'Workparams',
  data() {
    return {
  ...
  methods: {
    ...
    down() {
      ...
      obj.centralServerAddress = this.dialogform.centralServerAddress
      obj.centralServerPort = this.dialogform.centralServerPort
