<template>
  <div class="accSetting">
    <!-- <div class="searchAccSetting">
      <div class="inputBox">
        <div class="inputItem">
          <div class="label">充电机构</div>
          <div class="value">
            <treeselect
              :options="deptList"
              v-model="orgId"
      ...
      <div class="infoBox">
        ...
        <div class="accInfo" >
            ...
            <div class="item">
             ...
             <div class="item" v-if="accountInfo.accUse === 0">
                ...
                <!-- <span class="value" v-if="accountInfo.accType === 0">总金额 <span style="color: red;margin-left: 10px">{{accountInfo.totalAmount || 0}}</span></span> -->
            </div>
       ...
       <!-- 充值记录 -->
        <div class="accContent">
         <ShareItem v-if="accountInfo.accType === 0" :searchInfo="searchConf" :accountInfo="accountInfo"/>
         <QuotaAndPrivateItem v-if="accountInfo.accType === 2 || accountInfo.accType === 3" :searchInfo="searchConf" :accountInfo="accountInfo"/>
        </div>
      </div>

      <div class="noAccount" v-if="!showAccount && showContent">
        <div class="toOpen">此账户暂未开通</div> 
      </div>
    </div>
  </div>
</template>
