  ...
  <div class="addFault">
    ...
    >
      ...
      <!-- <div class="formContent switchContent">
                <div class="formList switchs">
                    <el-form-item label="是否与运营服务相关 :" prop="operationService">
                        <el-switch disabled v-model="dataInfo.operationService" active-text="是"
                                   inactive-text="否"></el-switch>
                    </el-form-item>
                </div>
                <div class="formList">
                    <el-form-item label="是否停机 :" prop="stopTag">
                        <el-switch disabled v-model="dataInfo.stopTag"   active-text="是"
                                   inactive-text="否"></el-switch>
                    </el-form-item>
                </div>
            </div> -->
      <!-- <el-form-item label="相关故障代码 :" prop="msgCode">
                <el-select disabled v-model="dataInfo.msgCode" clearable placeholder="请选择相关故障代码">
                    <el-option
      ...
      <!-- <el-form-item label="告警影响 :" prop="affect">
        <el-input v-model="dataInfo.affect" disabled type="textarea"></el-input>
      </el-form-item> -->
